...
export default function Form() {
  ...
  return (
	...
	<li><span role="img" aria-label="Green square">🟩</span> means you guessed the correct letter. Good job!</li>
	<li><span role="img" aria-label="Yellow square">🟨</span> means this letter is somewhere in the same row in your friend's game, excluding the green squares.</li>
        <li><span role="img" aria-label="Blue square">🟦</span> means this letter is somewhere in the same column in your friend's game, excluding the green squares.</li>
	<li><span role="img" aria-label="Purple square">🟪</span> means this letter is somewhere in the non-green squares in your friend's game, but not the same column or row.</li>
      </ul>
      <p>Have fun!</p>
